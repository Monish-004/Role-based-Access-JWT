...
public class SpringController
{
    ...
    // http://localhost:8080/about-doctor
    @GetMapping("about-doctor")
    @PreAuthorize("hasRole('DOCTOR')")
    public String spring()
    {
        return "Hey!! I AM A DOCTOR!";
    }

    // http://localhost:8080/about-patient
    @GetMapping("about-patient")
    @PreAuthorize("hasRole('PATIENT')")
    public String patient()
    {
        return "Hey!! I AM A PATIENT!";
    }
